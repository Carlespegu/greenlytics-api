...
import { ReadingsPage } from '@/modules/readings/pages/ReadingsPage';
...
export const router = createBrowserRouter([
  { path: '/login', element: <LoginPage /> },
  {
    ...
    children: [
      ...
      { path: 'installations/search', element: <InstallationsPage /> },
      ...
      { path: 'devices/search', element: <DevicesPage /> },
      ...
      { path: 'alerts/search', element: <AlertsPage /> },
      ...
      { path: 'readings/search', element: <ReadingsPage /> },
