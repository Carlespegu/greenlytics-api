  ...
  async function handleFinalSave() {
    ...
    try {
      const nextResult = await onSubmit({
        ...
        soilMoistureMin: draft.soilMoistureMin,
        soilMoistureMax: draft.soilMoistureMax,
        airHumidityMin: draft.airHumidityMin,
        airHumidityMax: draft.airHumidityMax,
        temperatureMin: draft.temperatureMin,
        temperatureMax: draft.temperatureMax,
        lightMin: draft.lightMin,
        lightMax: draft.lightMax,
